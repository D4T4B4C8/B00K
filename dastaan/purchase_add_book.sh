#!/usr/bin/env bash
#
# add_book.sh — Add a new book to index.html
#
# Usage:
#   ./add_book.sh
#   ./add_book.sh index.html
#
# What it does:
#   1. Asks for the image number (e.g. 05)
#   2. Maps it to front_image/05.webp
#   3. Looks up ../BOOK_05/05tags.txt (one level up, in the book/ folder)
#      for the book title, expecting a line like:
#         B="Some Book Title"
...
IMG_PATH="front_image/${IMG_NUM}.webp"
